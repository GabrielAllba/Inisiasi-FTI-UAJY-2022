...
<head>
    ...
    <title>Inisiasi FTI UAJY 2022 | Admin Login</title>
    {{-- toastr --}}
...
<body>
 ...
 <div style="max-width: 10rem">
    <img src="{{asset('admin/assets/images/logo-inisiasi.png')}}" class="img-fluid" alt="">
 </div>
 <form method="POST" action="{{route('store.admin.login')}}" 
 class="form-control" style="padding: 2rem; max-width: 30rem; display: flex; flex-direction: column; ">
     @csrf
 ...
 @endif
     ...
     <div class="form-outline mb-4">
         ...
         <input class="form-control" id="email" type="email" name="email" required autofocus></input>
     </div>
