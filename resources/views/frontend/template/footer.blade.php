...
<div style="position: relative" class="batu-cover">
    <img src="{{asset('images/batubatu.png')}}" class="batubatu" alt="">
</div>
<footer class="footer" style="position: relative">
    ...
    <div class="container" style="padding-bottom: 2rem; padding-top: 0;">
        <section style="padding-top: 3rem">
            <div class="row">
                <div class="col-md-4">
                    <h2 class="foot-title animate__animated " style="text-align: center">INISIASI FTI UAJY 2022</h2>
                    <h3 class="foot-title-2 animate__animated " style="padding-top: 1rem;text-align: center; color: #fcc899">FAKULTAS TEKNOLOGI INDUSTRI</h3>
                    <h3 class="foot-title-3 animate__animated " style="text-align: center; color: #fcc899; font-family: 'Poppins-Regular'">UNIVERSITAS ATMA JAYA YOGYAKARTA</h3>
                </div>
                   ...
                   <div class="col-md-4 info-boxx" style="padding-top: 0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" style="padding-top: 1rem">
                                <div class="d-flex">
                                    ...
                                    <a id="sosmed_{{$i}}" href="{{$item->link}}" target="_blank" class="outer ig" style="margin-right: .5rem">
                                        <div class="inner">
                    ...
                    <div class="col-md-4">
                     <div id="map"></div>
                     <div>
                        <p class="animate__animated alamatkuuu" style="padding-top: 1rem;font-size: .8rem ;color:#39434e ">Jl. Babarsari No.43, Janti, Caturtunggal, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281</p>
                     </div>
                     <style>
                        #map { height: 180px; }
                     </style>
    ...
    <div style="text-align: center; padding: 1rem; font-family: 'Poppins-Regular'; color:#2b323a ">
        ©2022 by Muldok & IT Inisiasi FTI UAJY 2022. All rights reserved.
    </div>
</footer>
<style>
    .batubatu{
